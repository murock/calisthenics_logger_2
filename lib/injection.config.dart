...
import 'data/datasources/database/tracked_exercise_db_helper.dart' as _i3;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i3.TrackedExerciseDbHelper>(
      () => _i3.TrackedExerciseDbHelper());
  gh.factory<_i4.TrackedExerciseDataSource>(() =>
      _i5.TrackedExerciseDataSourceImpl(
          dbHelper: get<_i3.TrackedExerciseDbHelper>()));
  ...
  gh.factory<_i9.TrackedExerciseBloc>(() => _i9.TrackedExerciseBloc(
      getSpecificTrackedExerciseOnDate:
          get<_i8.GetSpecificTrackedExerciseOnDate>()));
  return get;
}
